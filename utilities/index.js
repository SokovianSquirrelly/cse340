...
Util.getNav = async function () {
  let data = await invModel.getClassificationsInStock();
  let list = "<ul>";
...
Util.buildInventoryListing = async function (vehicle) {
  ...
  listing += `<h4>Mileage: ${new Intl.NumberFormat("en-US").format(
    vehicle.inv_miles
  )} miles</h4>`;
...
Util.buildClassificationList = async function (classification_id = null) {
  ...
  let classificationList =
    '<select name="classification_id" id="classificationList" class="textinp" required>';
